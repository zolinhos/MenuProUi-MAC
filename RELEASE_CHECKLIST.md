...
- [ ] Zip gerado: `dist/MenuProUI-MAC-app-macos-arm64-1.7.9.zip`
- [ ] Dmg gerado: `dist/MenuProUI-MAC-macos-arm64-1.7.9.dmg`
...
- [ ] Rodar script: `bash scripts/release_notarized_macos.sh 1.7.9`
- [ ] Validar Gatekeeper app: `spctl --assess --type execute -vvv dist/MenuProUI-MAC.app`
- [ ] Validar Gatekeeper dmg: `spctl --assess --type open -vvv dist/MenuProUI-MAC-macos-arm64-1.7.9.dmg`

## 4) Publicação no GitHub
- [ ] Criar tag `v1.7.9`
- [ ] Criar release "MenuProUI-MAC 1.7.9"
- [ ] Anexar `.zip` e `.dmg`
- [ ] Incluir changelog curto (atalhos, help, melhorias de empacotamento)

## 5) Alternativa sem Apple Developer (sem notarização)
- [ ] Rodar: `bash scripts/release_untrusted_macos.sh 1.7.9`
